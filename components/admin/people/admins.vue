  ...
  <div id="customers">
    ...
    <div id="table-wrapper">
      ...
      >
        ...
        <template
          v-slot:footer
          v-if="totalCustomers > adminList.length && adminList.length > 0"
        >
      ...
      <v-card justify="center" align="center">
        ...
        <v-card-text>
          <v-select
            ...
            v-model="adminLevel"
            :rules="[
            ()=> !!adminLevel || 'This field is required',
          ()=> adminLevel !== -1 || 'Select Admin Level']"
            label="Select Admin Level"
            name="Select Admin Level"
          ></v-select>
          ...
          <v-text-field
            ...
            label="Email"
            :readonly="sendingInvite || checkingEmail"
            hint="The Email of the Person you want to Create as An Admin"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        { text: "Admin's ID", value: 'id', sortable: false },
        {
          text: 'Name',
          align: 'left',
          value: 'name',
  ...
  mounted() {
    this.getAdminList()
    this.getAvailableAdminLevels()
  },
  methods: {
    getAvailableAdminLevels() {
      this.availableLevels = [4, 3, 2, 1]
    },
    createNewAdmin() {
      ...
      setTimeout(() => {
        ...
        this.snackBar = true
        this.snackMessage = 'Admin invite has been Sent'
      }, 3000)
    },
    getAdminList() {
    ...
    openPerson(id) {
      this.$emit('openUrl', {
        url: '/admin/people/admin/' + id,
        history: true
      })
    },

    LoadMore() {
      if (this.adminsLoading) {
        return
      }

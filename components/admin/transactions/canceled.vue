  ...
  <div id="customers">
    ...
    <div id="table-wrapper">
      ...
      >
        ...
        <template v-slot:header.date_canceled="{header}">
          <b>{{header.text}}</b>
        </template>
        ...
        <template v-slot:item.date_canceled="{item}">
          <span @click="openPerson(item.id)">{{item.date_canceled}}</span>
        </template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Canceled Date', value: 'date_canceled', sortable: false }
      ],

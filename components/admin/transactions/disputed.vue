  ...
  <div id="customers">
    ...
    <div id="table-wrapper">
      ...
      >
        ...
        <template v-slot:header.date_disputed="{header}">
          <b>{{header.text}}</b>
        </template>
        ...
        <template v-slot:item.date_disputed="{item}">
          <span @click="openPerson(item.id)">{{item.date_disputed}}</span>
        </template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Disputed Date', value: 'date_disputed', sortable: false }
      ],

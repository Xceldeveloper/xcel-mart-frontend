<template>
  <div id="wrapper">
      ...
      <v-card width="95%" max-width="600px" class="box-container" elevation="5">
        ...
        <div id="contact-info">
          ...
          <v-chip
            ...
            v-on="on"
          >
            <v-icon left>mdi-navigation</v-icon>Navigation
          </v-chip>
    ...
    <v-row class="fill-height ma-0" align="center" justify="center" v-if="isEmpty && !errorLoading">
      <v-card elevation="0">You have No Items On the Way</v-card>
    </v-row>
  ...
  methods: {
    getInformations() {
      ...
      setTimeout(() => {
        ...
        this.address_location = '333,333'
        this.ordertotal = 3245

<template>
  <div id="wrapper" v-cloak v-if="CANRENDER">
    ...
    <v-app-bar :color="Colors.accent" dense dark fixed>
      ...
      <v-toolbar-title>Queued For Delivery</v-toolbar-title>
    </v-app-bar>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-checkbox
            ...
            label="Are you sure u do not have any Pending Delivered Item Already in Route ?"
            :color="Colors.accent"
          ...
          <v-checkbox
            :readonly="veryfyingCanDeliver"
            label="If You Start Making Delivery for this you can't do another one till you are through with this one"

<template>
  <div id="wrapper" v-cloak v-if="CANRENDER">
    ...
    <v-app-bar :color="Colors.accent" dense dark fixed>
      ...
      <v-toolbar-title>New Package</v-toolbar-title>
    </v-app-bar>
      ...
      <v-card width="95%" max-width="600px" class="box-container" elevation="5">
        ...
        >
          <v-btn
            ...
            block
            dark
          >ACCEPT TO DELLIVER PACKAGE</v-btn>
        </v-card>
      </v-card>
    </v-row>
    ...
    >
      <v-card>
        <v-card-title>Accept to Deliver Package</v-card-title>
        <v-divider></v-divider>
        <v-card-text>
          <v-checkbox
            :readonly="veryfyingCanDeliver"
            label="Are you sure you can come to pickup the pacake for delivery As Soon As Possible ?"
            :color="Colors.accent"
            v-model="will_come_and_delivery_asap"
            value="value"
          ></v-checkbox>
          <v-checkbox
            :readonly="veryfyingCanDeliver"
            label="If  Accept  to deliver this package and you did not come to Deliever it you will be Penalized ?"
            v-model="will_be_penalized"
            :color="Colors.accent"
          ></v-checkbox>
        </v-card-text>
        <v-divider></v-divider>
        <v-card-actions>
          <v-btn
            v-if="will_come_and_delivery_asap && will_be_penalized "
            block
            :color="Colors.accent"
            dark
...
export default {
  ...
  data() {
    return {
      ...
      will_come_and_delivery_asap: false,
      will_be_penalized: false,
  ...
  methods: {
    getInformations() {
      ...
      setTimeout(() => {
        ...
        this.address_location = '333,2222'
        this.ordertotal = 780
    ...
    verifyDelivery() {
      ...
      setTimeout(() => {
        ...
        this.snackMessage = 'Package Added to Pending Deliveries...'
  ...
  watch: {
    makeDeliveryBottomSheet() {
      this.will_come_and_delivery_asap = false
      this.will_be_penalized = false
    }
  }
}
</script>

  ...
  <div id="transaction" v-cloak v-if="CANRENDER">
   ...
   :root{
    ...
    <v-app-bar :color="Colors.accent" dense dark fixed>
      ...
      <v-toolbar-title>Canceled Transaction</v-toolbar-title>
      <v-spacer></v-spacer>
...
export default {
  name: 'user-transaction-canceled-id',
  ...
  methods: {
    ...
    generalCall() {
      ...
      let orderDetails = {
        ...
        // date: '12/08/2020',
        // canceled_date: '12/08/2020',
        // canceledReason: 'I never got the goods in one piece'
      }
      ...
      if (hasError) {
        ...
        this.setOrderedDetails(orderDetails)
    ...
    setOrderedDetails(result) {
      ...
      this.canceledDate = result.canceled_date
